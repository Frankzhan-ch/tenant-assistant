                    ...
                    if req['photos']:
                        ...
                        for idx, photo_name in enumerate(req['photos']):
                            with cols[idx % 4]:
                                ...
                                button_label = "🖼️ 隐藏图片" if is_showing else f"🖼️ {photo_name}"
